# Source: https://docs.comma.ai/concepts/logs

# Logging

openpilot records routes in one minute chunks called segments. A [routeA route is a recording of an onroad session.](https://docs.comma.ai/concepts/glossary/#route) starts on the rising edge of ignition and ends on the falling edge.
...
For each [segmentRoutes are split into one minute chunks called segments.](https://docs.comma.ai/concepts/glossary/#segment), openpilot records the following log types:
