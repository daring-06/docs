# Source: https://docs.comma.ai/concepts/safety
...
To assist the driver in maintaining alertness, openpilot includes a driver monitoring feature that alerts when it detects driver distraction.
