...
openpilot is designed to be used on the [comma fourThe latest hardware by comma.ai for running openpilot. More info at comma.ai/shop/comma-four.](https://docs.comma.ai/concepts/glossary/#comma-four).
